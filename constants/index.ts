...
import { Role, Quadrant, TaskStatus, User, Department } from '../types';
...
export const STATUS_CONFIG: Record<TaskStatus, { title: string; color: string; bgColor: string }> = {
  [TaskStatus.TODO]: { title: 'CHƯA THỰC HIỆN', color: 'text-slate-500', bgColor: 'bg-slate-100' },
  ...
  [TaskStatus.CANCELLED]: { title: 'HỦY BỎ', color: 'text-rose-700', bgColor: 'bg-rose-100' },
